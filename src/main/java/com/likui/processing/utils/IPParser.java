package com.likui.processing.utils;
...
public class IPParser extends IPSeeker {
    ...
    public static void main(String[] args) {
        IPParser ipParser = new IPParser(ipFilePath);
        RegionInfo regionInfo = ipParser.analyseIp("124.79.172.232");
